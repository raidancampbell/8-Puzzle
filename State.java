...
public class State {
    ...
    public String hash() {//the hash is just the visial representation of the board as a String.  Useful for printing out, too
    ...
    private boolean canGoDown() {
        return (tileRow != length - 1);
    }

    private boolean canGoRight() {
        return (tileCol != length - 1);
    }
    ...
    private int manhattanPriority() {//lower priority means closer to the solution
        int priority = 0;
